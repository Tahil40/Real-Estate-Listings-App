...
// create TYPES list of objects and has type of label string and value of type PropertyType and if nothing then have type of empty list....
...
export default function FilterModal({
  ...
  //it will store array of those values which are not null in activeCount....
